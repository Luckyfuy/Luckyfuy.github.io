$(document).ready(function () {
    ...
    function getHeight() {
        if (question_name == 'YAVT 0.1.0' || question_name == 'YAVT 0.2.1') {
            return 800
        }
        else if (question_name == '8 Values') {
            return 700;
        }
        else if (question_name == 'LeftValues' || question_name == 'RightValues') {
            return 1000;
        }
        else {
            return 800;
    ...
    function drawGraph() {
        ...
        svg.text(`测试: ${question_name}`).attr({
            x: 20,
            y: height - 80,
            fill: "black"
        }).font(font_title);
        svg.text("luckyfuy.top/compass").attr({
            x: 20,
            y: height - 40,
            fill: "black"
        }).font(font_title);
